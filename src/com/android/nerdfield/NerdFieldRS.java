...
public class NerdFieldRS {
    public static String LOG_TAG = "NerdField";

    private Resources mRes;
    private RenderScriptGL mRS;
    private ScriptC_nerdfield mScript;
    private int mHeight;
    private int mWidth;
    ...
    public void init(int dpi, RenderScriptGL rs,
        ...
        mScript = new ScriptC_nerdfield(mRS, mRes, R.raw.nerdfield);
    ...
    private void createProgramVertex() {
        ...
        builder.setShader(mRes, R.raw.nerdfield_vs);
    ...
    private void createProgramFragment() {
        ...
        builder.setShader(mRes, R.raw.nerdfield_fs);
